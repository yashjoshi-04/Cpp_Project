...
public:
	EuropeanOption() {};
	EuropeanOption(OptionType _optType, double _strike, const Date& _expiry, const std::string& underlyingInstrument = "")
	    : TreeProduct(underlyingInstrument), optType(_optType), strike(_strike), expiryDate(_expiry) {};
	...
	// Public getters for option properties
